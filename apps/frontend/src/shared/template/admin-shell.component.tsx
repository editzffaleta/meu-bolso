  ...
  return (
    <div className="h-screen overflow-hidden bg-background text-foreground" data-testid="app-shell">
      <div className="flex h-full">
        <aside
          className={cn(
            'relative hidden h-screen shrink-0 overflow-hidden border-r border-nav-border bg-nav-bg shadow-[inset_0_1px_0_rgba(255,255,255,0.07)] lg:flex lg:flex-col',
        ...
        <SheetContent
          side="left"
          className="w-[22rem] max-w-[95vw] overflow-hidden border-nav-border bg-nav-bg p-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.07)]"
        >
