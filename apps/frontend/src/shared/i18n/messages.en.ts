...
export const errorMessagesEn: ErrorMessages = {
  ...
  'categorization-rule.keyword.required': 'Keyword is required.',
  'categorization-rule.keyword.invalid': 'Please enter a valid keyword.',
  'categorization-rule.categoryId.required': 'Category is required.',
  'categorization-rule.categoryId.uuid': 'Select a valid category.',
  'categorization-rule.priority.required': 'Priority is required.',
  'categorization-rule.priority.integer': 'Priority must be an integer.',
  'categorization-rule.userId.required': 'Invalid user.',
  'categorization-rule.userId.uuid': 'Invalid user.',
  'categorization-rule.not.found': 'Categorization rule not found.',
  'categorization-rule.category.not.found': 'Category not found.',
  'budget.categoryId.required': 'Category is required.',
  'budget.categoryId.uuid': 'Select a valid category.',
  'budget.month.required': 'Month is required.',
  'budget.month.regex': 'Enter the month in YYYY-MM format.',
  'budget.month': 'Enter the month in YYYY-MM format.',
  'budget.limitAmount.required': 'Limit is required.',
  'budget.limitAmount.positive': 'Limit must be greater than zero.',
  'budget.userId.required': 'Invalid user.',
  'budget.userId.uuid': 'Invalid user.',
